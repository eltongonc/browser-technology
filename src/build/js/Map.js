...
var map = {
    markCurrentPosition: function markCurrentPosition(radius) {
        return {
    ...
    createMarkers: function createMarkers(map, data) {
        ...
        data.points.map(function (point) {
            ...
            var tooltip = document.querySelector('#marker-tooltip');
...
var getMapInfo = function getMapInfo(data) {
